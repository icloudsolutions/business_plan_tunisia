  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        className={cn(
          "flex flex-1 items-center justify-between py-3 text-start text-sm font-medium text-slate-700 transition hover:text-slate-900 [&[data-state=open]>svg]:rotate-180",
          className
        )}
        {...props}
      >
